...
?>
  ...
  <!-- Form Start -->
  <section class="vh-100 log-form" style="background-color: #eee;">
            ...
            <div class="card-body p-md-5">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <!-- Form itself -->
                  <form class="mx-1 mx-md-4" method="post" action="log.php">
                  <div class="form-outline flex-fill mb-0 err">
                      <p style="color:red;font-style:italic;"><?php echo $errMsg ?></p>
                    </div>

                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <input type="email" id="form-email" value="<?php echo $email; ?>" name="email" class="form-control" />
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <button type = "submit" name = "button-log" class="btn btn-danger btn-lg">Войти</button>
                    </div>
